...
<div class="wrapper">
 ...
 <div class="container">
 	...
 	<div class="row"> 
	   ...
	   <img src="<?php echo base_url('assets/frontend/'); ?>images/menu-icon.png" class="micon jala" onclick="openNav()">
	       <div class="logo"><a href="<?php echo base_url(); ?>">PATCY CON</a></div>
	   </div>
 	<div class="col-sm-7 col-xs-6"> 
	  <div class="right_side">
	     <a style="font-size:14px;" href="tel:<?php echo $sitemanagementdata['phone']; ?>" class="desktop"><i class="fa fa-phone" aria-hidden="true"></i> <?php echo $sitemanagementdata['phone']; ?> </a> 
 ...
 <div id="myNav" class="overlay jalaton">
  <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>
  <div class="overlay-content">
                            <a href="<?php echo base_url(); ?>">home</a>
                            <a class="anir" href="#wholeconst">about us</a>
							<a class="anir" href="#what_we">what we do</a>
							<a  class="anir" href="#servicesweprovide">services</a>
							
						    <a href="<?php echo base_url('blog'); ?>">blog</a>
							<a class="anir" href="#testimonialblock">testimonial</a>
							<!--<a href="#">our team</a>-->
