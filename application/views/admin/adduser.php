        ...
        <div class="box box-primary">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">List of Driver</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
						<?php $vehicletypedetails =$this->db->get_where('vehicletype', array('id'=>$val['vehicletype']))->row_array(); echo $vehicletypedetails['title']; ?>
                    </td>
                    <td><?php echo $val['email']; ?></td>
                    <td><?php echo $val['phone']; ?></td>
                    <td><?php echo $val['vehiclenumber']; ?></td>
