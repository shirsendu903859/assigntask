...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1> Vehicle Management <small></small> </h1>
    <ol class="breadcrumb">
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary">
          <div class="box-header"> <i class="fa fa-taxi"></i>
            <h3 class="box-title">Vehicle Management</h3>
            <div class="pull-right">
              <button class="btn btn-primary addlogodialougeshow"><i class="fa fa-plus"></i> Add Vehicle</button>
            </div>
          </div>
              ...
              <div class="box-body">
                <div class="row">
                  <div class="form-group col-md-12">
                    <label for="inputEmail3" class="col-sm-3 control-label">Vehicle Title <span class="required">*</span></label>
                    <div class="col-sm-9">
                      <input type="text" name="title" class="form-control" id="inputEmail3" placeholder="Vehicle Title">
                    </div>
                  </div>
                  <div class="form-group col-md-12">
                  ...
                  <div class="form-group col-md-6">
                    <label for="inputEmail3" class="col-sm-3 control-label">Choose Driver <span class="required">*</span></label>
                    <div class="col-sm-9">
                      <select class="form-control">
                      	<option value=""></option>
                        <?php if(isset($driver) && !empty($driver)) { foreach($driver as $key=>$val) { ?>
                ...
                <div class="">
                  <div class="">
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <div class="addimagediv col-md-6" style="margin-top:20px; display:none;">
        ...
        <div class="col-md-12">
          <form class="editblogform" enctype="multipart/form-data">
            <div class="box-body">
              <div class="row">
                <div class="form-group col-md-12">
                  <label for="inputEmail3" class="col-sm-3 control-label">Service Title <span class="required">*</span></label>
                  <div class="col-sm-9">
                    <input type="text" name="title" class="form-control editblogtitle" id="inputEmail3" placeholder="Blog Title">
                  </div>
                </div>
                <div class="form-group col-md-12">
                  <label for="inputEmail3" class="col-sm-3 control-label">Service Description <span class="required">*</span></label>
                  <div class="col-sm-9">
                    <textarea id="editor3" name="description" class="editblogdesc" rows="10" cols="80"></textarea>
                  </div>
                </div>
                <div class="form-group col-md-12">
                  <label for="inputEmail3" class="col-sm-3 control-label">Service Short Description <span class="required">*</span></label>
                  <div class="col-sm-9">
                    <textarea id="editor4" name="shortdescription" class="editblogdescshort" rows="10" cols="80"></textarea>
                  </div>
                </div>
                <div class="clearfix"></div>
              </div>
