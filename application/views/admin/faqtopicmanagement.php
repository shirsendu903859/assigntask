...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1> FAQ Topic Management <small></small> </h1>
    <ol class="breadcrumb">
      <li><a href="<?php echo base_url('admin');?>"><i class="fa fa-dashboard"></i> Home</a></li>
      <li class="active">FAQ Topic Management</li>
    </ol>
  </section>
  <!-- Main content -->
      ...
      <div class="col-md-12">
        <div class="box box-primary">
          <div class="box-header"> <i class="fa fa-question-circle"></i>
            <h3 class="box-title">FAQ Topic Management</h3>
            <div class="pull-right">
              <button class="btn btn-primary addlogodialougeshow"><i class="fa fa-plus"></i> Add FAQ Topic</button>
            </div>
          </div>
              ...
              <div class="box-body">
                <div class="row">
                  <div class="form-group col-md-12">
                    ...
                    <div class="col-sm-9">
                      <input type="text" name="titleen" class="form-control" id="inputEmail3" placeholder="Topic Title English">
                    </div>
                  </div>
                  <div class="form-group col-md-12">
                    <label for="inputEmail3" class="col-sm-3 control-label">Topic Title <strong>(FR)</strong> <span class="required">*</span></label>
                    <div class="col-sm-9">
                      <input type="text" name="titlefr" class="form-control" id="inputEmail3" placeholder="Topic Title French">
                    </div>
                  </div>
                  <div class="clearfix"></div>
                </div>
                <div class="checkbox">
                  <button type="button" class="btn btn-primary pull-right savefaqtopicrvicemanagement"><i class="fa fa-floppy-o" aria-hidden="true"></i> Save</button>
