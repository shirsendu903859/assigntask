...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1> Category Management <small></small> </h1>
    <ol class="breadcrumb">
        ...
        <div class="box box-primary">
          <div class="box-header"> <i class="fa fa-list-alt"></i>
            ...
            <div class="pull-right">
              <button class="btn btn-primary addlogodialougeshow"><i class="fa fa-plus"></i> Add Category</button>
            </div>
          </div>
          <div class="box-body pad table-responsive addlogodialougebox" style="display:none;">
            <!--Upload logo part starts here-->
            <form class="categorymanagementform" enctype="multipart/form-data">
              <div class="box-body">
                <div class="row">
                ...
                <div class="checkbox">
                  <button type="button" class="btn btn-primary pull-right savecategorymanagement"><i class="fa fa-floppy-o" aria-hidden="true"></i> Save</button>
                  ...
                  <tr>
                    ...
                    <td>
                        <select class="form-control" name="editparentval form-control" disabled>
							...
							<?php foreach($categorydata as $keypre=>$valpre) { ?>
                      ...
                      <span class="changecategorystatus pointer" title="Change Category Status" data-id=<?php echo $val['id'];?>><i class="fa fa-thumbs-o-up fa-2x statusicon" aria-hidden="true"></i></span>
                      <?php } else { ?>
                      <span class="changecategorystatus pointer" title="Change Category Status" data-id=<?php echo $val['id'];?>><i class="fa fa-thumbs-o-down fa-2x statusicon" aria-hidden="true"></i></span>
                      <?php } ?>
                      <span class="editcategorydetails pointer" title="Edit Category Details" data-id="<?php echo $val['id']?>"><i class="fa fa-pencil-square-o fa-2x" style="color:#09F;" aria-hidden="true"></i></span> 
                      <!--<span class="deletecategory pointer" title="Delete Category" data-id="<?php echo $val['id']?>"><i class="fa fa-trash-o fa-2x" style="color:#f00;" aria-hidden="true"></i></span>--></td>
                  </tr>
                  <?php } ?>
                  </tbody>
